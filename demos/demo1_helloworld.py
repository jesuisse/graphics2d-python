...
def on_draw():
    ...
    fensterbreite, fensterhöhe = get_window_size()   # Holt die aktuelle Grösse des Fensters
    draw_filled_rect((0, 0), (fensterbreite, fensterhöhe), background_color)
